        ...
        <div id="postview-general" class="flex flex-wrap overflow-y-auto">
            ...
            <div id="postview-details" class="m-4 mt-0 w-1/4">
                <div id="postview-actions" class="mb-4">
                    ...
                    <button v-if="!this.$parent.postsList.find(p => p.id == post.id)" id="postview-addtolist-btn" @click="listPost" class="bg-indigo-400 py-2 w-full rounded hover:bg-indigo-500 shadow-lg hover:shadow-xl transition-100 mt-2">Add to list</button>
                    <button v-else id="postview-removefromlist-btn" @click="listPost" class="bg-red-400 py-2 w-full rounded hover:bg-red-500 shadow-lg hover:shadow-xl transition-100 mt-2">Remove from list</button>
                </div>
