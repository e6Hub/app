<template>
    <div id="app-version">
        ...
        <button v-else-if="this.$parent.$parent.updateState == 'uptodate'" @click="checkForUpdate" class="mt-4 bg-indigo-500 py-2 px-4 rounded focus:outline-none shadow-lg hover:shadow-xl transition-100">Check for updates</button>
