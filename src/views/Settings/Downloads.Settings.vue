<template>
    <div id="downloads-settings">
        <h3 class="text-base font-bold uppercase text-gray-500">Downloads</h3>
        <h4 class="text-sm font-bold uppercase text-gray-600">Current downloads folder</h4>
        <button id="selectDownloadLocation" @click="manageFolder" class="bg-indigo-400 py-2 px-4 rounded focus:outline-none shadow-lg hover:shadow-xl transition-100">Manage folder</button>
